...
<div id="intro">
	<div id="img-modal" class="modal modal1 modalA black darken-1" style="position: fixed; top: 63px !important; left: 250px !important;  width: auto !important;  height: auto !important; max-height: 100% !important; background-color: #000000;">
			...
			<div class="carousel carousel-slider center intro-carousel" >
				...
				<div class="carousel-item slide-1">
					...
					<h5 class="intro-step-title mt-5 center animated fadeInUp white-text">
						<a href="{{ route('dashboard.translator.myprofile.professionalDetails') }}" class="waves-effect waves-dark btn btn-lg btn-primary">Go to the Section</a>
					</h5>
				</div>
				<div class="carousel-item slide-2">
					...
					<h5 class="intro-step-title mt-5 center animated fadeInUp white-text">
						<a  href="{{ route('dashboard.translator.my-account.contracts') }}" class="waves-effect waves-dark btn btn-lg btn-primary">Go to the Section</a>
					</h5>
				</div>
